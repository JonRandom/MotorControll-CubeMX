...
extern const unsigned short ccermask[6];
...
// sk if(motorcurrent > maxcurrent) maxdutycycle=maxdutycycle-10;
// sk else
...
{
// sk reverse=initialreversesetting;
speed=0;
motorcurrent=0;
maxdutycycle=3100;
maxdutycycle=3100;
spdregtimer=10;
// sk spdcmd=initialspdcmd;
spdregintegral=0;
averagespeed=0;
speedsum=0;
speedcount=0;
